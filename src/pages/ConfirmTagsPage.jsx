...
const inputClass = 'min-w-0 flex-1 bg-transparent text-xs text-brown outline-none placeholder:text-brown/70'
...
export default function ConfirmTagsPage() {
  ...
  const [place, setPlace] = useState(data.place || '新北市 永和區')
